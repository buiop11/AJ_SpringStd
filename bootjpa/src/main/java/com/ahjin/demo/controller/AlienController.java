...
public class AlienController {
	...
	@RequestMapping(path="/aliens", produces= {"application/xml"})   // only xml 로만 받겠다 - consumes={"application/xml"}/ 포스트맨에서 해봄
	@ResponseBody
	...
	@DeleteMapping("/deleteAlien/{aid}") // 이렇게 쓸거면 @PathVariable 잊어먹지말기!  // @DeleteMapping? -> 쓰려면 @RestController로 수정
