...
John Abraham</span>is now following you
                        ...
                        <li class="nav-item dropdown nav-user">
                            ...
                            <img src="bootstrap/concept-master/assets/images/avatar-1.jpg" alt="" class="user-avatar-md rounded-circle"></a>
                    ...
                    <div class="collapse navbar-collapse" id="navbarNav">
                        <ul class="navbar-nav flex-column">
                            ...
                            <li class="nav-item">
                                ...
                                <i class="fas fa-fw fa-inbox"></i>Apps <span class="badge badge-secondary">New</span></a>
